...
def test_vectorizer_match_cases():
    ...
    case_2 = Case(filename="test.pdf", method="other_method")
    case_2.add_field("test", CaseField(value="test_value", confidence=0.5, evidence=Evidence.no_match()))
    cases = [case_1, case_2]
...
def test_vectorizer_get_value_list():
    ...
    case_1.add_field("test", CaseField(value="test_value", confidence=0.7, evidence=Evidence.no_match()))
    case_2 = Case(filename="test.pdf", method="other_method")
    case_2.add_field("test", CaseField(value="test_value_2", confidence=0.5, evidence=Evidence.no_match()))
    cases = [case_1, case_2]
